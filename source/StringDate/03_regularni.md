...
Замислите да радиш као програмер у банци и треба вам да провериш да ли је
корисник унео исправан број рачуна. Или радиш на веб сајту и мораш да провериш
да ли је адреса електронске поште коју је корисник унео заиста валидна. Можда
развијаш апликацију која треба да пронађе све датуме у тексту, или бројеве
телефона који почињу са +381.

Овакве типове задатака можеш решити помоћу регуларних израза (енлг.
*Regular Expressions* односно *Regex*) - моћан алат који ти омогућује да
дефинишеш сложене обрасце за претрагу, валидацију и манипулацију стрингова на
веома ефикасан начин.

Регуларни израз је низ карактера који дефинише образац за претрагу у тексту, а
образац је низ карактера који описује какав текст тражиш. На пример:
...
string pattern = "063/123-4567";
bool found = Regex.IsMatch(text, pattern);
Console.WriteLine($"Pronadjeno: {found}"); // Pronadjeno: True
```
...
Квантификатори говоре колико пута се претходни карактер или група понавља.
...
операције где можеш да их примениш.
