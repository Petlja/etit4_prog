...
У првој форми можеш "видети" акције корисника на другој форми овако:
...
Једноставан и чест начин комуникације међу формама је да једна форма, приликом
креирања друге форме, пошаље податке кроз конструктор. На пример, ако је
потребно послати неки текст из `Form1` у `Form2`, кôд у другој форми може да
изгледа овако...
...
Други, такође прилично једноставан начин за комуникацију између форми је да
дефинишеш својства у другој форми, чиме омогућаваш другој форми да прими
податке из прве. На пример, кôд у другој форми може да изгледа овако...
