...
.NET Framework нуди уграђене дијалоге који пружају стандардан и познат начин за
...
да изабере боју из палете основних боја, дефинише прилагођене боје или одабере
...
Toolbox, пронађите ColorDialog контролу у секцији Dialogs и превуци је на
