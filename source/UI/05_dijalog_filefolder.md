...
...препоручљиво је да користиш `using` блокове, јер ове класе имплементирају
...
се у лабели, а садржај фајла у оквиру за текст. Подсети се из претходних
...
Кликом на то дугме кориснику треба приказати дијалог за чување текстуалног
фајла у којем ће се сачувати садржај оквира за текст:

![Дијалог за чување фајла](./images/cuvanje2.png)

Када корисник сачува фајл, путања до сачуваног фајла треба да буде
приказана у лабели:
...
Кликом на то дугме кориснику треба приказати дијалог за одабир фолдера...
...
* отварања и приказа садржаја текстуалног фајла,
...
У апликацијама које би израђивао за кориснике, требало би да додаш и try-catch
блокове приликом рада са фајловима како би се адекватно руковало изузецима (нпр.
