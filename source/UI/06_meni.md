...
Наравно, све ово можеш урадити и динамички из кода, без коришћења дизајнера, у
неколико корака:
...
![Креирана пречица](./images/meni3.png)
...
тог карактера. Дефинисањем тастера за приступ додаје се могућност унапређења
...
Овим си јасно одвојио групу подставки од подставке `Izlaz`:

![Додавање сепаратора](./images/meni5.png)

Значи, сепаратор нема својство `Text` нити је видљив, нити представља ставку коју
...
уочљивости функција менија. Како су иконе слике малих формата, већина популарних
