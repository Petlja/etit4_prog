...
користи се за извршавање SQL упита над базом и `SqlDataReader` користи се за
...
`SqlConnection` се користи за везу са *SQL Server* базом података, `SqlCommand`
се користи за извршавање SQL упите над базом и `SqlDataAdapter` се користи као
...
се за чување података у меморији твог рачунара.
