...
изузетно лоша пракса, пре свега из безбедносних разлога. Конструисање упита
...
Ускладиштена процедура `usp_Ubaci` прихватиће два параметра (`@CompanyName`
...
корисник унео податке. Ако јесте, позива се метода унутар `try-catch` блока.
Уколико је све прошло како треба, добија се ID новог превозника, обавештава
корисник о успеху и припрема форма за следећи унос. У случају грешке,
`catch` блок је хвата и приказује одговарајућу поруку.
