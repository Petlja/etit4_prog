...
* **Connection** се користи за конекцију са базом,
...
*DataSet* представља репрезентацију података у меморији која омогућава рад без
...
*SQL Server Data Provider* један је од најважнијих ADO.NET провајдера и део је
...
* `SqlParameter`, користи се за параметризоване упите или процедуре, и
