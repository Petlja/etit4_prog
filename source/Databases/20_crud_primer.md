...
све то знање објединиш и направимо једну комплетну апликацију која омогућава
...
Први корак је припрема базе података. Креираћеш од једном четири ускладиштене
...
На крају треба да креираш кориснички интерфејса. Форма треба да има `ListView`
...
на избор производа и попуњава `TextBox` контроле и три медоте за догађаје клика
...
Имај у виду да већ унете податке нећеш моћи да обришеш јер би због
референцијалног интегритета и да ће покушај брисања тих података бацити
изузетак! Моћићеш да бришеш само податке које си ти унео!
