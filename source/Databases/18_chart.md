...
графиконе креиране у апликацијама за табеларне прорачуне попут апликације
Microsoft Excel.
...
`UcitajSve()` као и у претходним лекцијама.
...
додељено је првих десет производа, па су мапиране X и Y осе - X за називе
...
(`UnitsOnOrder`). У овом примеру, немој да користиш DataSource, већ можеш
