...
Креираћемо апликацију у којој се лоптица креће по екрану, одбија од ивица и
...
`OnPaint` методу да га поново исцрташ." **Двоструко баферовање** спечава
...
Када спојиш све до сада објашњено доћићеш до функционалног кода игре Понг:
...
2. Повећање тежине:
    * Убрзај лоптицу током времена. На пример, након сваког одбијања од рекета,
