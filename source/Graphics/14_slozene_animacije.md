...
"рециклирање" – када звезда прође поред посматрача и нестане са екрана (када
...
представи једна звезда. Уместо гомиле одвојених променљивих, користи се класа
...
Иницијализација свемира врши се у конструктору форме где се поставља сцена –
дефинише се изглед прозора, креира почетна популација звезда и покреће
анимациона петља (тајмер).
...
беле). Сачувај ту боју као ново својство у класи `zvezda` и користи је
приликом цртања.
* **Комете или астероиди** - повремено, уместо тачке, нацртај малу линију или
сличицу астероида који се креће кроз поље звезда.
