...
провидна, док у првом та вредност није наведена - подразумевана вредност алфа
канала је 255, што значи да је боја потпуно непрозирна (*opaque*).
...
Ове структуре ћеш често користити у методама као што су `DrawLine()`,
