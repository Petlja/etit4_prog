...
*Graphics Device Interface Plus*) система програмског језика C# и налази се у
именском простору
...
Мање поуздан начин за креирање графичких објекта је помоћу `CreateGraphics()`
...
Трећи начин користи се када треба да црташ на слици тј. битмапи. Тада можеш да
...
када је потребно да се прозор освежи. `FillEllipse` црта пун месец жуте боје на
задатим координатама, задате величине. `DrawEllipse` црта контуру тог истог
круга црном бојом. Слично, `FillRectangle` попуњава тело кућице зелено-смеђом
бојом, а `DrawRectangle` црта ивицу тела кућице црном бојом. Дефинисани низ
