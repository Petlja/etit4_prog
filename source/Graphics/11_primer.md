...
Да бисмо нацртао праву $ax + by = c$, потребно је да пронађеш координате две
...
апликације. Овај догађај се аутоматски покреће сваки пут када је треба освежити
...
која ресетује све податке и, такође позивом `pnlCanvas.Invalidate()`, што
