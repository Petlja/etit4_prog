...
У датом примеру креирана је форма (`Form1`) димензија 320×240 пиксела и под
...
У конструктору, нова нит `nit` се покреће методом `PokreniAnimaciju`. Ова
...
контрола животног циклуса помоћу флега `aktivna`, а обрада изузетака спречава
...
где више нити приступа истим подацима, што може да доведе до конфликата.

За разумевање ове теме и конкурентног програмирања потребно је одвојити много
