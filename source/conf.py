...
project = 'Програмирање IV за информатичке профиле у електротехничким школама'
copyright = '2025, Фондација Петља'
author = 'Светлана Радловачки'
...
html_title = 'Програмирање IV за информатичке профиле у електротехничким школама'
