...
садржи само један или неколико елемената.

Пошто се елементима приступа на основу њиховог хеш кода, операције над хешсетом
имају очекивану временску сложеност $O(1)$. Иако се више елемената може наћи у
истој канти (због *колизије* хешева), просечан број елемената по канти је мали,
па укупно време извршавања операције не зависи значајно од укупног броја
елемената у хешсету. Међутим, у најгорем случају, због колизија, сложеност може
порасти на $Θ(n)$ јер се елементи тада складиште у линеарну структуру – листу
повезаних елемената у истој канти.

Иначе, колизија се јавља када се користи хеш функција, сваки елемент се смешта
у одговарајућу канту на основу свог хеш кода. Пошто број могућих хеш кодова није
бесконачан, може се догодити да два различита елемента имају исти хеш код или да
се њихови хеш кодови мапирају на исту канту.
