...
могу се изоставити. Слично, ако израз има само један параметар, мале заграде
око њега се могу изоставити.

Следе примери неких ламбда израза и њихов опис:
...
типа `T` и враћа резултат типа `T`; `return funkcija(vrednost)` примењује
