...
Ред представља колекцију објеката у коју се елементи додају на једном крају
листе који се назива крај реда, а уклањају на другом крају листе, који се
назива почетак реда. То значи да се елементи из реда уклањају истим редоследом
којим су и додавани у ред (енгл. *First In First Out - FIFO*). Значи, FIFO
...
се може дефинисати као FIFO колекција инстанци истог типа променљиве
...
уклања се елемент на почетку реда – у овом случају, елемент `10`. Значи,
...
да можеш приступити само елементу на почетку реда, док приступ
...
ред (осим на крај), нити да сортираш елементе реда.
