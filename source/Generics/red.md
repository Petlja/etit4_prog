...
Ред представља листу елемената у којима се елементи додају на једном крају
листе који се назива крај реда, а уклањају на другом крају листе, који се
назива почетак реда. о значи да се елементи са реда уклањају истим редоследом
