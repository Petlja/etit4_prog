...
Извршавањем следећег програма у којем се позива методa `Podrazumevano`...
...
Извршавањем следећег програма у којем се позива методa `IspisiIme`...
...
* класе које немају јавни конструктор без параметара – ако класа има само
...
...па ће се позивом генеричке методе `Ispisivanje` са прослеђеним типом
класе `Automobil`...
...
услова истовремено. Вишеструка ограничења такође се задају помоћу кључне
...
нека ограничење буде такво да први типски параметар мора да буде референтни, 
а други вредносни тип:
