...
[Колекције података](07_kolekcije.md) поненуто је да је колекција хешсет у
...
Генеричка колекција хешсет оптимизована је за брзе операције додавања, уклањања
и претраживања елемената. Има просечну временску сложеност $Θ(1)$, што је
чини веома ефикасном. Временска сложеност $Θ(1)$ значи да време извршења
операције остаје константно, без обзира на величину колекције, што је могуће
...
Приликом уклањање или претраживање елемената у хешсету, израчунава се хеш кôд
...
линеарну претрагу, као нпр. у генеричкој где је временска сложеност $Θ(n)$. У
идеалном случају, хеш функција распоређује елементе равномерно по кантама, тако
да свака канта садржи само један или неколико елемената. Пошто приступ канти
преко хеш кода траје константно време, а број елемената у канти је мали, 0 или
1, укупно време операције је независно од укупног броја елемената у хешсету –
отуда $Θ(1)$.
...
...јер скуп `skupA` једсте надскуп скупа `skupB`, односно, скуп `skupB` није
надскуп скупа `skupA`.
